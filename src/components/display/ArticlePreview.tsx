        ...
        {isGeneratingContent ? (
          <div className="text-center py-8 text-gray-500 flex flex-col items-center justify-center min-h-[200px]">
            ...
            <p className="font-semibold text-lg">
              <span className="font-bold text-blue-600 animate-pulse inline-block transform transition-all duration-1000 hover:scale-110">
                <span className="inline-block animate-[bounce_2s_ease-in-out_infinite]">파</span>
                <span className="inline-block animate-[bounce_2s_ease-in-out_infinite_0.1s]">코</span>
                <span className="inline-block animate-[bounce_2s_ease-in-out_infinite_0.2s]">월</span>
                <span className="inline-block animate-[bounce_2s_ease-in-out_infinite_0.3s]">드</span>
              </span>가 글을 생성하고 있습니다...
            </p>
