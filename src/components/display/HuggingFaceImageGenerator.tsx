...
import { Loader2, Copy, Image as ImageIcon, Wand2, ChevronDown, ChevronUp } from 'lucide-react';
...
export const HuggingFaceImageGenerator: React.FC<HuggingFaceImageGeneratorProps> = ({
  ...
  const [isCollapsed, setIsCollapsed] = useState(false); // 기본값을 false로 변경 (펼쳐진 상태)
