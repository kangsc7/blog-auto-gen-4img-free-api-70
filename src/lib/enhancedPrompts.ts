...
export const getEnhancedArticlePrompt = async ({
  ...
  return `
        ...
        **🚨 각 섹션 글자수 조정 - 190자에서 250자 사이 🚨**
        각 H2 섹션의 본문 내용은 반드시 **190자에서 250자 사이**로 작성해야 합니다.
        ...
        **🚨 문단 구성 및 가독성 규칙 (매우 중요) 🚨**
        ...
        - 한 <p> 태그 안에 너무 긴 내용을 넣지 마세요 (최대 140글자 기준)
        ...
        **🚨 SEO 최적화를 위한 외부 링크 규칙 (축소) 🚨**
        - 본문에 3-5개의 권위 있는 외부 링크를 자연스럽게 포함해주세요 (글자수 절약을 위해 축소)
