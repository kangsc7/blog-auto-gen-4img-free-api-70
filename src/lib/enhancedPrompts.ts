...
export const getEnhancedArticlePrompt = async ({
  ...
  // 강화된 H2 섹션 글자수 지침 (500-600자)
  const sectionLengthGuideline = `
🔥 **H2 섹션별 글자수 강력한 지침 (최고 우선순위)**:
- 각 H2 소제목 아래 본문은 **반드시 공백 포함 500자에서 600자 사이**로 작성
...
4. **각 H2 섹션**: ${sectionLengthGuideline}에 따라 500-600자의 풍부한 내용
