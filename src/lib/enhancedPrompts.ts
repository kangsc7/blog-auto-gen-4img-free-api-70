...
8. **태그**: 참조 링크 뒤에 두 개의 공백줄을 추가한 후 쉼표로 구분된 태그 7개 나열
...
[키워드 1], [키워드 2], [키워드 3], [키워드 4], [키워드 5], [키워드 6], [키워드 7]` : ''}
...
- 참조 링크 뒤에 두 개의 공백줄(<br><br>)을 추가한 후 쉼표로 구분된 태그 7개 나열
- 태그는 주제 '${topic}'와 키워드 '${keyword}'와 관련된 실용적인 태그들로 구성
- 태그 앞에 '태그:' 같은 접두사는 절대 포함하지 말고 순수 태그만 나열
