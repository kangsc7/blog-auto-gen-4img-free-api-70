...
const PROTECTED_GUIDELINES = {
  WORD_COUNT_LIMIT: "각 H2 섹션 600-700자",
...
3. **검색 트렌드 고려**: 최신 검색 트렌드와 사용자 관심사를 반영한 소제목과 함께, 각 섹션별 약 600-700자의 풍부한 설명을 작성해주세요.
4. 설명은 단순 요약이 아닌, 다음 요소를 반드시 포함해야 합니다:
   ...
   - 각 섹션은 공백 포함 600자에서 700자 사이로 작성해주세요
...
5. **검색 트렌드 고려**: 최신 검색 트렌드와 사용자 관심사를 반영한 소제목과 함께, 각 섹션별로 약 600-700자의 풍부한 설명을 작성해주세요.
...
- **각 H2 섹션 본문: 정확히 600-700자 범위 내**
- **700자 초과 금지, 600자 미만 금지**
- **글자수 카운트 후 범위 확인 필수**
...
**🚨 글자수 제한 - 절대 준수 사항 🚨**
**각 H2 섹션의 본문은 반드시 공백 포함 600자에서 700자 사이로 작성해야 합니다.**
- 이 글자수 제한은 절대적이며, 700자를 초과하거나 600자 미만이 되어서는 안 됩니다
- **140자를 초과하면 두 번째 문장의 마침표(.) 부분에서 반드시 줄바꿈을 하고 공백 줄 하나를 추가하세요**
- **모든 문단은 반드시 <p> 태그로 감싸서 작성하세요**
- **각 <p> 태그 사이에는 공백 줄바꿈을 추가하여 가독성을 높이세요**
- 섹션 작성 후 반드시 공백 포함 글자수를 카운트하여 600-700자 범위 내인지 확인하세요
...
- **각 섹션은 정확히 공백 포함 600자에서 700자 사이의 적절한 분량이어야 합니다**
- **절대로 700자를 초과하거나 600자 미만이 되어서는 안 됩니다**
