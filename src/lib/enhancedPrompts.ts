...
- 섹션 작성 후 반드시 글자수를 카운트하여 190-250자 범위 내인지 확인하세요
...
.single-summary-card .card-header h3 {
    ...
    line-height: 1.3;
    font-weight: 700;
    background: linear-gradient(45deg, ${colors.textHighlight}, ${colors.secondary});
    padding: 8px 16px;
    border-radius: 15px;
...
<div class="single-summary-card-container">
    <div class="single-summary-card">
        ...
        <div class="card-content">
            <div class="section"><strong>지원 대상:</strong> <span class="highlight">[구체적인 대상과 자격 조건]</span></div>
            <div class="section"><strong>지원 금액:</strong> <span class="highlight">[지원 금액과 혜택 내용]</span></div>
            <div class="section"><strong>신청 방법:</strong> <span class="highlight">[온라인 또는 오프라인 신청 방법]</span></div>
            <div class="section"><strong>필요 서류:</strong> <span class="highlight">[신청에 필요한 서류 목록]</span></div>
            <div class="section"><strong>신청 기간:</strong> <span class="highlight">[신청 기간과 중요 일정]</span></div>
        </div>
...
<div style="text-align: center; margin: 40px 0; padding: 25px; border-radius: 15px; border: 2px solid ${colors.primary};">
...
- **가독성 최우선**: 190-250자 범위 내에서 140자 도달 시 두 번째 문장 마침표에서 </p> 태그로 닫고 공백 줄바꿈 추가 후 새로운 <p> 태그로 시작
