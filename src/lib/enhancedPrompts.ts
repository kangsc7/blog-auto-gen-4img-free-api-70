...
export const getEnhancedArticlePrompt = async ({
  ...
  return `
        ...
        - **콘텐츠 분량 (매우 중요)**: 전체 글자 수는 반드시 **2800자에서 3200자 사이**여야 합니다. 크롤링된 풍부한 정보를 활용하여 이 분량 제한을 엄격하게 지켜주세요.
        - **키워드 활용**: 핵심 키워드 '${keyword}'를 글 전체에 자연스럽게 녹여내세요. 크롤링된 정보에서 관련 키워드도 함께 활용하여 SEO 효과를 높이세요.
        - 콘텐츠 스타일: 제공된 HTML 템플릿과 스타일을 정확히 사용해야 합니다. 모든 섹션을 크롤링된 정보를 바탕으로 풍부하고 자연스러운 콘텐츠로 채워주세요.
        ...
        - 가독성 향상: 크롤링된 풍부한 정보를 독자가 쉽게 읽을 수 있도록 **각 단락은 최대 3개의 문장으로 구성**해주세요.
        ...
        - **최종 규칙**: 크롤링된 최신 정보를 최대한 활용하여 **콘텐츠 분량 2800-3200자**를 반드시 준수하면서도 독자에게 실질적인 가치를 제공하는 글을 작성해주세요.
